...
/* ============================================================
   ...
   Purpose: Payment confirmation + next steps
   ============================================================ */
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center 
      ...
      <h1 className="text-5xl font-extrabold text-green-400 
                     drop-shadow-[0_0_30px_#22c55e] mb-6">
        ✅ Payment Confirmed
      </h1>
      <p className="text-lg text-gray-200 max-w-2xl mb-10">
        Your support has been logged in the{" "}
        <span className="text-purple-300">PhoenixOps</span> system.
        <br />
      ...
      {/* === Next Steps Box === */}
      <div className="bg-black/70 border-2 border-purple-500 rounded-xl 
                      shadow-[0_0_25px_#a855f7] p-6 max-w-md mb-10">
        <h2 className="text-2xl font-bold text-purple-400 
                       drop-shadow-[0_0_20px_#a855f7] mb-3">
          What Happens Next
        </h2>
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        <Link
          ...
          className="px-6 py-3 rounded-lg font-semibold bg-green-500 
                     ...
                     drop-shadow-[0_0_20px_#22c55e] transition"
        >
          Back to Store
        </Link>
        <Link
          href="/contact"
          className="px-6 py-3 rounded-lg font-semibold border border-purple-400 
                     text-purple-300 hover:bg-purple-900/40 
                     drop-shadow-[0_0_20px_#a855f7] transition"
        >
          Contact Support
        </Link>
      </div>
