...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-black px-6 py-16 text-center">
      {/* === Hero Section === */}
      <h1 className="text-6xl font-extrabold text-purple-400 drop-shadow-[0_0_30px_#a855f7]">
        Welcome to PhoenixOps
      </h1>
      <p className="mt-4 text-xl text-purple-300 drop-shadow-[0_0_15px_#9333ea]">
        Automation • Innovation • Hustle
      </p>

      {/* === Bots Grid === */}
      <section className="grid grid-cols-1 md:grid-cols-4 gap-10 mt-16 max-w-7xl mx-auto">
        {/* MIA */}
